        ...
        <div className="min-h-screen flex justify-start items-center">
            <div className="w-1/2 flex flex-col gap-7">
                <div className="flex flex-col gap-7">
                    <h1 className="font-bold text-5xl text-primary-color">Seja bem vindo ao meu Portfólio</h1>
                    <p>Meu nome é Otávio Alencar e aqui vou mostrar meus projetos e minhas habilidades como programador front-end</p>
                </div>
